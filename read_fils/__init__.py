...
class ReadFilament2D:
    def __init__(self,file_path=None):
        ...
        """
        Make a filaments dictionary out of 2D ASCII NDSKL file
        """
...
class ReadFilament:
    def __init__(self,file_path=None):
        ...
        """
        Make a filaments dictionary out of 3D ASCII NDSKL file
        """
        self.file_path = file_path
        self.filament_dict = None
        self.read_data()
    ...
    def read_data(self):
        ...
        ##### Critical Points (peaks, saddle points, minima, bifurcation points)
